...
$contenu_gauche.="<p class='lead'>Couleurs</p>
                <div class='list-group'><a href='?couleur=all' class='list-group-item'>Toutes</a>";
...
while ( $produit = $donnees->fetch(PDO::FETCH_ASSOC)){
    ...
    $contenu_droite.= "<div class='col-sm-4 hauteur'>
                            <div class='thumbnail'>
                            <a href='fiche_produit.php?id_produit=".$produit['id_produit']."'><img src='".$produit['photo']."' class='img-responsive'>
                                <div class='caption'>
                                <h4 class='pull-right'>".$produit['prix']." €</h4>
                                <h4>".$produit['titre']."</h4></a>
