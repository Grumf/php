...
function executeRequete( $sql, $params=array() ){
    ...
    return $r; // On retourne l'objet issu de la requête à l'endroit où la fonction à été appelée
}

function creationPanier(){

    // Si il n'existe pas, on le créé vide
...
function retirerProduitPanier($id_article_a_supp){
    ...
    if ( $position_produit !== false ){
        ...
        // efface et remplace une portion de tableau à partir de l'indice et sur 1 indice (1 ligne)
    }
